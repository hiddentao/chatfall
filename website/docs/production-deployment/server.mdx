...
Every Chatfall release includes a single binary executable that can be used to run the Chatfall server. 
...
process manager like [PM2](https://pm2.keymetrics.io/) in that case. Remember to set the correct [environment variables](../environment-variables.mdx).
