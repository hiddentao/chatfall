...
<script>
  ...
  // END
  iframe.srcdoc = `
    <link rel="stylesheet" href="${serverUrl}/chatfall.css" crossorigin="anonymous" />
    <script type="module">
      import { Chatfall } from '${serverUrl}/chatfall.es.js';
      Chatfall.init({
        serverUrl: '${serverUrl}',
...
:::tip
By customizing the iframe styling you can fully control the layout and size of the widget.
:::
